document.addEventListener("DOMContentLoaded", () => {
  ...
  const correlatividades = {
    // SEGUNDO AÑO
    "FISIOLOGÍA": ["ANATOMÍA DESCRIPTIVA Y TOPOGRÁFICA I","BIOQUÍMICA","BIOFÍSICA","EMBRIOLOGÍA Y DESARROLLO"],
   "TÉCNICAS Y MANEJO DE ALIMENTOS": ["BIOQUÍMICA", "NUTRICIÓN NORMAL", "BIOFÍSICA"],
    "PSICOLOGÍA SOCIAL E INSTITUCIONAL": ["EDUCACIÓN PARA LA SALUD","PSICOSOCIALES","EMBRIOLOGÍA Y DESARROLLO"],
    "EPIDEMIOLOGÍA": ["INTRODUCCIÓN AL PENSAMIENTO CIENTÍFICO I"],
    "BROMATOLOGÍA Y TECNOLOGÍA DE LOS ALIMENTOS": ["BIOQUÍMICA","NUTRICIÓN NORMAL"],
    "ATENCIÓN PRIMARIA DE LA SALUD": ["NUTRICIÓN NORMAL","EDUCACIÓN PARA LA SALUD","INTRODUCCIÓN AL PENSAMIENTO CIENTÍFICO I","PSICOSOCIALES","EMBRIOLOGÍA Y DESARROLLO","NUTRICIÓN DEL NIÑO Y ADOLESCENTE SANO"],
    "ADMINISTRACIÓN, ORGANIZACIÓN Y GESTIÓN DE SERVICIOS": ["PSICOLOGÍA SOCIAL E INSTITUCIONAL"],
